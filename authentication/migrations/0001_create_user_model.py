# Generated by Django 6.1 on 2026-08-25 18:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firebase_uid', models.CharField(help_text='Firebase Authentication user UID', max_length=128, unique=True)),
                ('email', models.EmailField(help_text="User's email address", max_length=254, unique=True)),
                ('phone', models.CharField(blank=True, max_length=16)),
                ('full_name', models.CharField(blank=True, max_length=255)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('commissioner', 'Commissioner'), ('manager', 'Manager'), ('viewer', 'Viewer')], db_index=True, default='viewer', max_length=20)),
                ...
                ('can_view_all_boards', models.BooleanField(default=False)),
